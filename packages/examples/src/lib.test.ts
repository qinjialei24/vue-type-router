...
describe("Typesafe Router", () => {
  ...
  describe("createTypesafeRoute", () => {
    it("should create a TypesafeRoute object", () => {
      ...
      expect(route).toHaveProperty("pushWithDynamicParamsAndQuery");
      expect(route).toHaveProperty("pushWithDynamicParams");
    });
    ...
    it("pushWithDynamicParamsAndQuery should call vueRouter.push method with correct params", () => {
      const mockPush = vi.fn();
      // @ts-ignore
      window[vueRouterKey] = { push: mockPush };
    ...
    it("pushWithDynamicParams should call vueRouter.push method with correct params", () => {
      const mockPush = vi.fn();
      // @ts-ignore
      window[vueRouterKey] = { push: mockPush };
